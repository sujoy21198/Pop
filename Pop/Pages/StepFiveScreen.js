    ...
    render() {
        return (
            <View style={{ backgroundColor: BaseColor.BackgroundColor, flex: 1 }}>
                ...
                <View style={{ borderBottomColor: BaseColor.Stroke, borderBottomWidth: 1, marginTop: heightToDp('1.5%'), width: widthToDp("100%") }}></View>
                <Text style={{fontSize:widthToDp("6%"),marginLeft:widthToDp("3%"),marginTop:heightToDp("1%"),fontFamily:'Oswald-Medium'}}>STEP - 05/08</Text>
                <ScrollView>
                ...
                <View style={{ height: heightToDp("10%") }}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('StepSixScreen')}>
